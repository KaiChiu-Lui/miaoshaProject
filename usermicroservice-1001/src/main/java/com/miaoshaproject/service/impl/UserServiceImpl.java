...
//        }
    ...
    public UserModel convertUserInfomationFromDataObject(UserDO userDO){
        UserModel userModel = new UserModel();
        BeanUtils.copyProperties(userDO,userModel);
        return userModel;
    }
    ...
    public List<UserModel> list() {
        ArrayList<UserDO> list = userDOMapper.list();
        ArrayList<UserModel> userModels = new ArrayList<>();
        for(UserDO userDO : list){
            UserModel userModel = convertUserInfomationFromDataObject(userDO);
